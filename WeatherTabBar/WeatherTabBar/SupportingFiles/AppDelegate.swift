...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        // 1. Change this when coding programatically
        // Create a new Window
        ...
        let madrid = City(name: "Madrid", country: "Spain", temp: 30, icon: "italy", summary: "Rainy")
        ...
        saoVC.city = sao
        saoVC.view.backgroundColor = .yellow
        let madVC = CityViewController()
        madVC.city = madrid
        madVC.view.backgroundColor = .blue
        
        let tabBarViewControler = UITabBarController()
        window?.rootViewController = tabBarViewControler
        
        // array of my view controlers
        let citiesVC = [vanVC,tokVC,saoVC,madVC]
        
        // mapping each one of them into a navigationviewControler and added to a tabBarViewControler
        tabBarViewControler.viewControllers = citiesVC.map { UINavigationController(rootViewController: $0) }
        
        window?.makeKeyAndVisible()
        // end of code added manually
